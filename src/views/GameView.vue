...
.round-display { display: flex; flex-direction: column; align-items: center; background: rgba(255,255,255,0.1); padding: 5px 12px; border-radius: 12px; }
...
.icon-text-btn { background: var(--glass); border: var(--glass-border); color: #fff; padding: 8px 12px; border-radius: 10px; font-size: 13px; font-weight: 500; cursor: pointer; }
...
/* 卡片网格 */
.players-grid { 
  flex: 1; overflow-y: auto; padding: 20px; display: grid; grid-template-columns: 1fr; gap: 16px; align-content: start;
}
@media (min-width: 600px) or (orientation: landscape) { .players-grid { grid-template-columns: repeat(2, 1fr); } }

.p-card { 
  background: var(--glass); border: var(--glass-border); border-radius: 20px; padding: 20px;
  display: flex; flex-direction: column; position: relative; overflow: hidden; transition: 0.2s;
}
.p-card:active { transform: scale(0.97); background: rgba(255,255,255,0.1); }
...
.tag { background: rgba(255,255,255,0.1); font-size: 12px; padding: 4px 10px; border-radius: 10px; display: flex; align-items: center; gap: 6px; }
...
.sheet-handle { width: 40px; height: 5px; background: rgba(255,255,255,0.3); border-radius: 3px; margin: 0 auto 20px; }
.sheet-title { text-align: center; font-size: 20px; font-weight: bold; margin-bottom: 20px; }

/* Segmented Control */
.segmented-control { display: flex; background: rgba(0,0,0,0.3); border-radius: 12px; padding: 4px; margin-bottom: 20px; }
...
/* Tab Content */
.tab-content { max-height: 45vh; overflow-y: auto; padding-bottom: 10px; }
.flex-col { display: flex; flex-direction: column; gap: 12px; }
.event-btn-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 12px; }
.e-btn { display: flex; justify-content: space-between; align-items: center; font-size: 15px; }
...
.edit-box { background: rgba(255,255,255,0.05); padding: 15px; border-radius: 16px; margin-bottom: 5px; }
.edit-box label { display: block; font-size: 13px; color: var(--text-muted); margin-bottom: 8px; }

/* 目标选择模式 */
.target-mode h3 { text-align: center; font-size: 18px; margin-bottom: 5px; }
...
.target-btn { background: rgba(255,255,255,0.08); justify-content: flex-start; }
.btn-cancel { width: 100%; background: rgba(255,255,255,0.1); }
...
.modal-center-content h3 { text-align: center; font-size: 18px; margin-bottom: 15px; }
...
.list-item { background: rgba(255,255,255,0.05); padding: 12px 16px; border-radius: 12px; display: flex; align-items: center; gap: 12px; font-weight: 500; border: 2px solid transparent; transition: 0.2s; cursor: pointer; }
